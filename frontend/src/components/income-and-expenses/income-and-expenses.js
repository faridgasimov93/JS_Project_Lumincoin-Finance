...
export class IncomeAndExpenses {
    ...
    filterOperations(startDate = null, endDate = null) {
        ...
        if (startDate && endDate) {
            ...
            // По умолчанию фильтруем на "сегодня"
            filtered = this.allOperations.filter(operation => {
                const operationDate = new Date(operation.date);
    ...
    showRecords(operations) {
        ...
        operations.forEach((operation) => {
            ...
            lastTdElement.classList.add('table-actions-buttons', 'd-flex', 'align-items-center', 'justify-content-end');
            ...
            <a href="/income-and-expenses-edit?=${operation.id}" class="edit-table">
